...
CREATE TABLE User(
    ...
    threshold_accumulated DECIMAL(10,2) DEFAULT 0
);
...
CREATE TABLE UsedDiscountCode (
    ...
    code VARCHAR(50),               -- 可為 NULL，處理活動折扣
    discount_id INT NOT NULL,       -- 不可為 NULL
    order_id INT NOT NULL,          -- 用來儲存訂單 ID
...
-- ADD DEFAULT GUEST FIRST
INSERT INTO User (user_id, name, email, password, birthday, register_date, role)
VALUES (1, 'Default Guest', 'guest@fitfuel.com', 'N/A', '2000-01-01', CURRENT_DATE, 'guest');

-- ADD DEFAULT DISCOUNTS
INSERT INTO Discount (name, discount_amount, is_percentage, is_single_use, is_recurring)
VALUES ('Birthday 15% OFF', 0.85, true, true, false);
INSERT INTO Discount (name, discount_amount, is_percentage, is_single_use, is_recurring)
VALUES ('Threshold $500 OFF', 500, false, true, false);